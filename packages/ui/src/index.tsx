...
export function ThreadPane(props: ThreadPaneProps) {
  const { conversation, messages, composerValue, replyTarget, onComposerChange } = props;
    ...
    <section className="panel panel--thread">
            ...
            <footer className="message-bubble__footer">
              ...
              <div className="reaction-row">
                {message.reactions.map((reaction) => (
                  <span key={`${message.id}-${reaction.emoji}`} className="reaction-chip">
      ...
      <footer className="composer">
        ...
        <div className="composer__actions">
          <button className="secondary-button" type="button">🙂 React</button>
